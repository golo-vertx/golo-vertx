...
public class FileSystem {
    ...
    // TypeParams: [] 
        ...
        //evenTypes (remove later):      ASYNC_RESULT   
        return InternalHelper.safeCreate(this.delegate.props(path,new Handler<AsyncResult<io.vertx.core.file.FileProps>>() {
...
handler.handle((AsyncResult<FileProps>)f);
         }
       }
), io.vertx.golo.core.file.FileSystem.class); 
    }
    ...
    // TypeParams: [] 
        public FileSystem lprops(String path,Handler<AsyncResult<FileProps>> handler) {
                //param classes(remove later):   STRING   HANDLER  
        //evenTypes (remove later):      ASYNC_RESULT   
        return InternalHelper.safeCreate(this.delegate.lprops(path,new Handler<AsyncResult<io.vertx.core.file.FileProps>>() {
         public void handle(AsyncResult<io.vertx.core.file.FileProps> event) {
           AsyncResult<FileProps> f;
           if (event.succeeded()) {
             f = InternalHelper.<FileProps>result(new FileProps(event.result()));
...
handler.handle((AsyncResult<FileProps>)f);
    ...
    // TypeParams: [] 
        public FileSystem readFile(String path,Handler<AsyncResult<Buffer>> handler) {
                //param classes(remove later):   STRING   HANDLER  
        //evenTypes (remove later):      ASYNC_RESULT   
        return InternalHelper.safeCreate(this.delegate.readFile(path,new Handler<AsyncResult<io.vertx.core.buffer.Buffer>>() {
...
handler.handle((AsyncResult<Buffer>)f);
         }
       }
), io.vertx.golo.core.file.FileSystem.class); 
    }
    ...
    // TypeParams: [] 
        ...
        //evenTypes (remove later):        ASYNC_RESULT   
        return InternalHelper.safeCreate(this.delegate.open(path,options,new Handler<AsyncResult<io.vertx.core.file.AsyncFile>>() {
...
handler.handle((AsyncResult<AsyncFile>)f);
         }
       }
), io.vertx.golo.core.file.FileSystem.class); 
    }
    ...
    // TypeParams: [] 
        public FileSystem fsProps(String path,Handler<AsyncResult<FileSystemProps>> handler) {
                //param classes(remove later):   STRING   HANDLER  
        //evenTypes (remove later):      ASYNC_RESULT   
        return InternalHelper.safeCreate(this.delegate.fsProps(path,new Handler<AsyncResult<io.vertx.core.file.FileSystemProps>>() {
...
handler.handle((AsyncResult<FileSystemProps>)f);
         }
       }
), io.vertx.golo.core.file.FileSystem.class); 
    }
