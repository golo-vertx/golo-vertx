...
//io.vertx.core.dns.DnsClient
   ...
   */
  public DnsClient lookupStringHandler<AsyncResult<String>>(String name, Handler<AsyncResult<String>> handler) {
...
//io.vertx.core.dns.DnsClient
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public DnsClient lookup4StringHandler<AsyncResult<String>>(String name, Handler<AsyncResult<String>> handler) {
...
//io.vertx.core.dns.DnsClient
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public DnsClient lookup6StringHandler<AsyncResult<String>>(String name, Handler<AsyncResult<String>> handler) {
...
//io.vertx.core.dns.DnsClient
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public DnsClient resolveAStringHandler<AsyncResult<List<String>>>(String name, Handler<AsyncResult<List<String>>> handler) {
...
//io.vertx.core.dns.DnsClient
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public DnsClient resolveAAAAStringHandler<AsyncResult<List<String>>>(String name, Handler<AsyncResult<List<String>>> handler) {
...
//io.vertx.core.dns.DnsClient
   ...
   * @return a reference to this, so the API can be used fluently.
   */
  public DnsClient resolveCNAMEStringHandler<AsyncResult<List<String>>>(String name, Handler<AsyncResult<List<String>>> handler) {
...
//io.vertx.core.dns.DnsClient
   ...
   * @return a reference to this, so the API can be used fluently.
   */
  public DnsClient resolveMXStringHandler<AsyncResult<List<MxRecord>>>(String name, Handler<AsyncResult<List<MxRecord>>> handler) {
...
//io.vertx.core.dns.DnsClient
   ...
   * @return a reference to this, so the API can be used fluently.
   */
  public DnsClient resolveTXTStringHandler<AsyncResult<List<String>>>(String name, Handler<AsyncResult<List<String>>> handler) {
...
//io.vertx.core.dns.DnsClient
   ...
   * @return a reference to this, so the API can be used fluently.
   */
  public DnsClient resolvePTRStringHandler<AsyncResult<String>>(String name, Handler<AsyncResult<String>> handler) {
...
//io.vertx.core.dns.DnsClient
   ...
   * @return a reference to this, so the API can be used fluently.
   */
  public DnsClient resolveNSStringHandler<AsyncResult<List<String>>>(String name, Handler<AsyncResult<List<String>>> handler) {
...
//io.vertx.core.dns.DnsClient
   ...
   * @return a reference to this, so the API can be used fluently.
   */
  public DnsClient resolveSRVStringHandler<AsyncResult<List<SrvRecord>>>(String name, Handler<AsyncResult<List<SrvRecord>>> handler) {
...
//io.vertx.core.dns.DnsClient
   ...
   * @return a reference to this, so the API can be used fluently.
   */
  public DnsClient reverseLookupStringHandler<AsyncResult<String>>(String ipaddress, Handler<AsyncResult<String>> handler) {
