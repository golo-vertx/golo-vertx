...
//void
   ...
   */
  public void getKHandler<AsyncResult<V>>(K k, Handler<AsyncResult<V>> resultHandler) {
...
//void
   ...
   */
  public void putKVHandler<AsyncResult<Void>>(K k, V v, Handler<AsyncResult<Void>> completionHandler) {
...
//void
   ...
   */
  public void putKVLongHandler<AsyncResult<Void>>(K k, V v, long ttl, Handler<AsyncResult<Void>> completionHandler) {
...
//void
   ...
   * @param completionHandler the handler
   */
  public void putIfAbsentKVHandler<AsyncResult<V>>(K k, V v, Handler<AsyncResult<V>> completionHandler) {
...
//void
   ...
   * @param completionHandler the handler
   */
  public void putIfAbsentKVLongHandler<AsyncResult<V>>(K k, V v, long ttl, Handler<AsyncResult<V>> completionHandler) {
...
//void
   ...
   */
  public void removeKHandler<AsyncResult<V>>(K k, Handler<AsyncResult<V>> resultHandler) {
...
//void
   ...
   * @param resultHandler - this will be called some time later to signify the value has been removed
   */
  public void removeIfPresentKVHandler<AsyncResult<Boolean>>(K k, V v, Handler<AsyncResult<Boolean>> resultHandler) {
...
//void
   ...
   */
  public void replaceKVHandler<AsyncResult<V>>(K k, V v, Handler<AsyncResult<V>> resultHandler) {
...
//void
   ...
   */
  public void replaceIfPresentKVVHandler<AsyncResult<Boolean>>(K k, V oldValue, V newValue, Handler<AsyncResult<Boolean>> resultHandler) {
...
//void
   ...
   */
  public void clearHandler<AsyncResult<Void>>(Handler<AsyncResult<Void>> resultHandler) {
...
//void
   ...
   */
  public void sizeHandler<AsyncResult<Integer>>(Handler<AsyncResult<Integer>> resultHandler) {
