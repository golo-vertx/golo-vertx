...
//void
   ...
   */
  public void getHandler<AsyncResult<Long>>(Handler<AsyncResult<Long>> resultHandler) {
...
//void
   ...
   * @param resultHandler handler which will be passed the value
   */
  public void incrementAndGetHandler<AsyncResult<Long>>(Handler<AsyncResult<Long>> resultHandler) {
...
//void
   ...
   * @param resultHandler handler which will be passed the value
   */
  public void getAndIncrementHandler<AsyncResult<Long>>(Handler<AsyncResult<Long>> resultHandler) {
...
//void
   ...
   * @param resultHandler handler which will be passed the value
   */
  public void decrementAndGetHandler<AsyncResult<Long>>(Handler<AsyncResult<Long>> resultHandler) {
...
//void
   ...
   * @param resultHandler handler which will be passed the value
   */
  public void addAndGetLongHandler<AsyncResult<Long>>(long value, Handler<AsyncResult<Long>> resultHandler) {
...
//void
   ...
   * @param resultHandler handler which will be passed the value
   */
  public void getAndAddLongHandler<AsyncResult<Long>>(long value, Handler<AsyncResult<Long>> resultHandler) {
...
//void
   ...
   */
  public void compareAndSetLongLongHandler<AsyncResult<Boolean>>(long expected, long value, Handler<AsyncResult<Boolean>> resultHandler) {
