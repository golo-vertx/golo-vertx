...
//void
   ...
   */
  public void getResultHandler(Handler<AsyncResult<Long>> resultHandler) {
...
//void
   ...
   * @param resultHandler handler which will be passed the value
   */
  public void incrementAndGetResultHandler(Handler<AsyncResult<Long>> resultHandler) {
...
//void
   ...
   * @param resultHandler handler which will be passed the value
   */
  public void getAndIncrementResultHandler(Handler<AsyncResult<Long>> resultHandler) {
...
//void
   ...
   * @param resultHandler handler which will be passed the value
   */
  public void decrementAndGetResultHandler(Handler<AsyncResult<Long>> resultHandler) {
...
//void
   ...
   * @param resultHandler handler which will be passed the value
   */
  public void addAndGetValueResultHandler(long value, Handler<AsyncResult<Long>> resultHandler) {
...
//void
   ...
   * @param resultHandler handler which will be passed the value
   */
  public void getAndAddValueResultHandler(long value, Handler<AsyncResult<Long>> resultHandler) {
...
//void
   ...
   */
  public void compareAndSetExpectedValueResultHandler(long expected, long value, Handler<AsyncResult<Boolean>> resultHandler) {
