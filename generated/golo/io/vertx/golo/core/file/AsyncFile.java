...
private io.vertx.core.file.AsyncFile originalInstance;// boolean writeQueueFull() 
...
public io.vertx.core.file.AsyncFile setReadBufferSize(int readBufferSize) {
        return originalInstance.setReadBufferSize(); 
}
}
