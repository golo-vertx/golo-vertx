...
public static io.vertx.core.parsetools.RecordParser newDelimited(java.lang.String delim, io.vertx.core.Handler<io.vertx.core.buffer.Buffer> output) {
        return InternalHelper.safeCreate(io.vertx.core.parsetools.RecordParser.newDelimited(delim, output), io.vertx.golo.core.parsetools.RecordParser.class); 
}
...
public static io.vertx.core.parsetools.RecordParser newFixed(int size, io.vertx.core.Handler<io.vertx.core.buffer.Buffer> output) {
        return InternalHelper.safeCreate(io.vertx.core.parsetools.RecordParser.newFixed(size, output), io.vertx.golo.core.parsetools.RecordParser.class); 
}
