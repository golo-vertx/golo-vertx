...
private io.vertx.core.Future<T> originalInstance;// <TypeParamInfo.Method[name=T,typeName=io.vertx.core.Future,methodNamefuture]> io.vertx.core.Future<T> future() 
...
public <TypeParamInfo.Method[name=T,typeName=io.vertx.core.Future,methodNamefailedFuture]> io.vertx.core.Future<T> failedFuture(java.lang.String failureMessage) {
        return originalInstance.failedFuture(); 
}
// boolean isComplete() 
...
public void setHandler(io.vertx.core.Handler<io.vertx.core.AsyncResult<T>> handler) {
        return originalInstance.setHandler(); 
}
